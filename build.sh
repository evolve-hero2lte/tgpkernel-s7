...
# -------------
clear
echo "TGPKernel PWMFix S7 Build Script v$BUILD_SCRIPT -- Kernel Version: v$VERSION_NUMBER"
echo ""
echo " 0) Clean Workspace"
echo "00) Clean CCACHE"
echo ""
echo " 1) Build TGPKernel PWMFix boot.img for S7"
echo " 2) Build TGPKernel PWMFix boot.img for S7 Edge"
echo " 3) Build TGPKernel PWMFix boot.img for S7 + S7 Edge"
echo " 4) Build TGPKernel PWMFix boot.img and .zip for S7"
echo " 5) Build TGPKernel PWMFix boot.img and .zip for S7 Edge"
echo " 6) Build TGPKernel PWMFix boot.img and .zip for S7 + S7 Edge (Seperate)"
echo " 7) Build TGPKernel PWMFix boot.img and .zip for S7 + S7 Edge (All-In-One)"
echo ""
echo " 9) Exit"
echo ""
